                ...
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a target="_blank" class="dropdown-item" href="http://docs.bookingcore.co">Documentation</a>
                    ...
                    <ul class="menu">
                        ...
                        <li><a target="_blank" href="http://docs.bookingcore.co">Documentation</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="social">
            ...
            <ul>
                ...
                <li><a href="mailto:bookingcore.co@gmail.com"><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
