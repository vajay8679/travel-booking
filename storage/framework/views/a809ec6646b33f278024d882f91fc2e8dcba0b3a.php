            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Booking Core by')); ?> <a href="<?php echo e(__('https://www.bookingcore.co')); ?>" target="_blank"><?php echo e(__('BookingCore Team')); ?></a>
                    </div>
                    <div class="col-md-6">
...
<?php /**PATH /var/www/html/Project/travel-booking/modules/Layout/admin/app.blade.php ENDPATH**/ ?>