...
class MapEngine
{
    ...
    public static function scripts()
    {
        ...
        switch (setting_item('map_provider')) {
            case "gmap":
                $html .= sprintf("<script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyA-JYTuTNzkY3mFtUQdfYA4agtWXrpatSk&libraries=places'></script>", setting_item('map_gmap_key'));
